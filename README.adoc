...
DEORECATED - This guide was deprecated. You may visit the new https://openliberty.io/guides/microprofile-tele.html[Enabling distributed tracing in microservices with MicroProfile OpenTelemetry] guide to learn how to enable tracing by using MicroProfile OpenTelemetry.
