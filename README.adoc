...
You'll need to use different commands if you use a different tracing system.
...
Before you proceed, confirm that your Zipkin server is up and running. By default, Zipkin can be found
...
which indicates that the span caught an error. 
...
Make sure that your services are running. 
...
In a real-world scenario, implement all the OpenTracing interfaces that you deem necessary, 
