...
Start your Zipkin server and point your browser to {inv-url}. When you visit this endpoint, you make a GET HTTP request to the `inventory` service.
This GET request is configured to be traced, and therefore a new trace entry of one span long will appear
in your Zipkin server. Navigate to your Zipkin server to verify this, it usually resides at {zipkin-url}. Next, point to {inv-url}/localhost.
