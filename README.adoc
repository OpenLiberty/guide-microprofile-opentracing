...
Note that this user feature also comes with the
...
Next, run the `mvn package` command from to rebuild your services. Point to {inv-url}, check your Zipkin
...
image::/guides/draft-guide-microprofile-opentracing/resources/enable-tracing.png[png][Enable tracing, float=left]
...
image::/guides/draft-guide-microprofile-opentracing/resources/disable-tracing.png[png][Disable tracing, float=left]
...
image::/guides/draft-guide-microprofile-opentracing/resources/inject-tracer.png[png][Inject tracer, float=left]

This is just a simple example of what you can do with the injected Tracer object. More configuration
