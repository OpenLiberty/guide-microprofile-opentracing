...
you deem necessary, which may include the `SpanBuilder` interface. You can use this interface for span
...
You have just utilized MicroProfile OpenTracing to customize how and which traces are delivered to Zipkin.
