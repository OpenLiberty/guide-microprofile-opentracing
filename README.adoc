...
When you are done checking out the services, stop both Open Liberty servers by running the following command:
...
Tweak the existing `inventory/src/main/java/io/openliberty/guides/inventory/InventoryManager.java` file
...
Now, tweak the existing `inventory/src/main/java/io/openliberty/guides/inventory/InventoryResource.java` file
