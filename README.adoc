...
Because tracing of all JAX-RS methods is enabled by default, you need only to enable the MicroProfile
OpenTracing feature and the Zipkin user feature in the [hotspot=mpOpenTracing file=0]`server.xml` file to see some basic traces in Zipkin.
