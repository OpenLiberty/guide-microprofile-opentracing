...
This guide was deprecated. You may visit the new https://openliberty.io/guides/microprofile-tele.html[Enabling distributed tracing in microservices with MicroProfile OpenTelemetry] to learn how to enable tracing by using MicroProfile OpenTelemetry.
