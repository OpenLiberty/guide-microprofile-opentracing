...
traced. For example, while all JAX-RS methods are traced by default, you can disable tracing by using
...
interfaces that you deem necessary, which might include the `SpanBuilder` interface. You can use this
...
You have just used MicroProfile OpenTracing to customize how and which tracers are delivered to Zipkin.
