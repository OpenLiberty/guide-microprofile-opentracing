...
ifdef::cloud-hosted[]
For this guide, use Zipkin as your distributed tracing system.
...
Before you proceed, make sure that your Zipkin server is up and running by checking the Zipkin URL:
