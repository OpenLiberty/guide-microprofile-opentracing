...
invalid, an error is thrown. This behavior is expected.
...
user feature that is provided. In a real development environment, implement all the OpenTracing
interfaces that you deem necessary, which may include the `SpanBuilder` interface. You can use this
interface for span creation and customization, including setting timestamps.
